...
const Login = () => {
  ...
  const login = useGoogleLogin({
    onSuccess: (codeResp) => handleGoogleLogin(codeResp),
    onError: (error) => {
  ...
  const handleGoogleLogin = async (tokenInfo) => {
    ...
    try {
      ...
      console.log('Login: User saved to localStorage:', resp.data);
      // Dispatch event to update Header - use a small delay to ensure localStorage is set
      setTimeout(() => {
        window.dispatchEvent(new Event('userUpdated'));
        console.log('Login: userUpdated event dispatched');
      }, 100);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    // TODO: Implement email/password login with Supabase Auth
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link to="/auth/forgot-password" className="text-orange-600 hover:text-orange-700 font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="text-center pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/auth/signup" className="text-orange-600 hover:text-orange-700 font-semibold inline-flex items-center gap-1">
